...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — pondex_" },
      { name: "description", content: "Get in touch with the pondex_ team." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <h1 className="mt-8 text-4xl font-bold tracking-tight text-ink">Contact</h1>
